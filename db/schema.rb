...
ActiveRecord::Schema.define(version: 20170222143603) do
  ...
  add_index "ci_commits", ["project_id", "ref", "status"], name: "index_ci_commits_on_project_id_and_ref_and_status", using: :btree

...
describe Gitlab::Diff::Highlight, lib: true do
  ...
  describe '#highlight' do
    context "with a diff file" do
      subject { Gitlab::Diff::Highlight.new(diff_file, repository: project.repository).highlight }
    ...
    context "with diff lines" do
      subject { Gitlab::Diff::Highlight.new(diff_file.diff_lines, repository: project.repository).highlight }

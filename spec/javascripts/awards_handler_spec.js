      ...
      openAndWaitForEmojiMenu = function() {
        return new Promise((resolve, reject) => {
          if (isEmojiMenuBuilt) {
            ...
            // Doesn't fire in phantomJS because no CSS is loaded in
            // We could make the code more aware of whether the menu actually has a CSS transition
            // see https://github.com/MadLittleMods/jquery-carouselss/blob/b6363cf70875d83c2b2df1806e1025777720675d/lib/get-max-transition-duration-from-change.js

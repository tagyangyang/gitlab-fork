...
describe Project, models: true do
  ...
  describe '#remove_artifacts' do
    it 'removes all associated artifacts' do
      build = create(:ci_build, :success, :artifacts)

      build.pipeline.project.remove_artifacts

      expect(build.artifacts_file.exists?).to eq(false)
      expect(build.artifacts_metadata.exists?).to eq(false)
    end
  end
end

...
AwardsHandler.prototype.createEmojiMenu = function createEmojiMenu(callback) {
  const addRemainingEmojiMenuCategories = this.addRemainingEmojiMenuCategories.bind(this);
  ...
  const $menu = $('.emoji-menu');
  this.registerEventListener('on', $menu, transitionEndEventString, function menuTransitionEndHandler(e) {

/* eslint-disable func-names, space-before-function-paren, quotes, no-var, object-shorthand, consistent-return, no-unused-vars, comma-dangle, vars-on-top, prefer-template, max-len, prefer-arrow-callback */

function Compare(opts) {
  this.opts = opts;
  this.source_loading = $(".js-source-loading");
  this.target_loading = $(".js-target-loading");
  $('.js-compare-dropdown').each(function(i, dropdown) {
    var $dropdown;
    $dropdown = $(dropdown);
